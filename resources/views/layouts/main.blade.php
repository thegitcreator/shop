...
<div class="wrapper">
    ...
    <div class="preloader flex-column justify-content-center align-items-center">
        <p class="animation__shake">Магазин одежды</p>
    </div>
    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
        ...
        <a href="index3.html" class="brand-link">
            <span class="brand-text font-weight-light">Магазин одежды</span>
        </a>
    ...
    <footer class="main-footer">
        <strong> &copy; 2022-{{ now()->year }} <a href="{{ route('main.index') }}">Магазин одежды</a>.</strong>
        Все права защищены.
    </footer>
